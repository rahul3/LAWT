...
#SBATCH --error=/home/rahul3/scratch/2026/slurm_output/%x_%j.err

# Run the bashrc first
. ~/.bashrc
export SHALLOW_NN_TRAIN="/home/rahul3/projects/def-sbrugiap/rahul3/icprai_2026/LAWT/src/neuralnet/deepnetwork_hd_train.py"
export LAWT_PATH="/home/rahul3/projects/def-sbrugiap/rahul3/icprai_2026/LAWT"
...
srun $PYTHON_EXEC $SHALLOW_NN_TRAIN 
