...
#SBATCH --output=/home/rahul3/scratch/2026/slurm_output_fourier_encoder_cosine/%x_%j.out
#SBATCH --error=/home/rahul3/scratch/2026/slurm_output_fourier_encoder_cosine/%x_%j.err

# Run the bashrc first
. ~/.bashrc
export FOURIER_ENCODER_TRAIN="/home/rahul3/projects/def-sbrugiap/rahul3/icprai_2026/LAWT/src/neuralnet/transformer_wo_embedding/train_enc_fourier_cosine.py"
export FOURIER_ENCODER_DUMP_PATH="/home/rahul3/scratch/experiments_fourier_encoder_cosine"
